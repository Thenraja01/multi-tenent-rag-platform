...
async def test_create_admin_globex():
    async with httpx.AsyncClient(base_url=BASE_URL, timeout=10.0) as client:
        ...
        print("Using Role ID:", org_admin_role["id"], org_admin_role["name"])

        # 3. Create admin@globex.com
        payload = {
            "name": "admin",
            "full_name": "admin",
...
if __name__ == "__main__":
    asyncio.run(test_create_admin_globex())
